...
Вы можете вводить либо регистронезависимое имя, или цифровое значение. Не заданные параметры будут по умолчанию заданы как `Private`. Важно помнить о наследовании одних параметров от других, как указано выше, поскольку параметр-наследник не может иметь более открытые настройки приватности чем его параметр-родитель. Например, вы **не можете** иметь настройку `Public` для списка игр, если у вас есть настройка `Private` профиля.

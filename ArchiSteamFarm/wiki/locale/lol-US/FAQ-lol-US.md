...
PLZ, USE SUM COMMON SENSE AN DOAN ASSUME DAT U CAN DO SUCH CRAZY THINGS ONLY CUZ ASF ALLOWS U 2 DO DAT. DOIN `loot ASF` ON OVAR 1K OV BOTS CAN BE EASILY CONSIDERD **[DDOS](https://en.wikipedia.org/wiki/DDoS)** ATTACK, AN PERSONALLY IM NOT SHOCKD DAT SOMEBODY GOT BANND 4 SUCH TING. Keep minimum of fair use in regards to Steam service, and **most likely** you'll be fine.
